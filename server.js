...
Отвечай на русском, структурированно. Дай конкретные советы.`;
    ...
    try {
        ...
        res.json({ success: false, error: error.message, type: 'trainer', bmiData });
    }
});
...
Учти принцип: "треть желудка — пища, треть — вода, треть — воздух". Отвечай на русском.`;
    ...
    try {
        ...
        res.json({ success: false, error: error.message, type: 'diet', bmiData });
    }
});
...
Отвечай на русском: распорядок дня, техники восстановления, сон.`;
    ...
    try {
        ...
        res.json({ success: false, error: error.message, type: 'energy', bmiData });
    }
});
